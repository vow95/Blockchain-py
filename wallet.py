...
class Wallet:
    ...
    def sign_transaction(self, sender, recipient, productid):
        """Sign a transaction and return the signature.

        Arguments:
            :sender: The sender of the transaction.
            :recipient: The recipient of the transaction.
            :productid: The productid of the transaction.
        """
        signer = PKCS1_v1_5.new(RSA.importKey(binascii.unhexlify(self.private_key)))
        h = SHA256.new((str(sender) + str(recipient) + str(productid)).encode('utf8'))
    ...
    def verify_transaction(transaction):
        ...
        h = SHA256.new((str(transaction.sender) + str(transaction.recipient) + str(transaction.productid)).encode('utf8'))
