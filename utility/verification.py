...
class Verification:
    ...
    @staticmethod
    def verify_transaction(transaction, get_assets, check_productid=True):
    ...
    @classmethod
    def verify_transactions(cls, open_transactions, get_assets):
        """Verifies all open transactions."""
        return all([cls.verify_transaction(tx, get_assets, False) for tx in open_transactions])